    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-primary-600 to-primary-700 text-white py-20">
        <div className="container-custom text-center">
          ...
          <p className="text-xl max-w-2xl mx-auto">{t.donate.description}</p>
        </div>
      </section>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  title:
                    locale === "ar" ? "الدعم النفسي" : "Psychological Support",
                  description:
                    locale === "ar"
              ...
              {[
                {
                  ...
                  value:
                    locale === "ar"
                      ? "جمعيه إسعاد الطفل الفلسطيني"
                      : "Association for Happiness of the Palestinian Child",
                },
                {
                  label: t.donate.bankDetails.accountNumber,
                  value: locale === "ar" ? "30167" : "30167",
                },
                {
                  label: t.donate.bankDetails.bankName,
                  value: locale === "ar" ? "Quds Bank" : "Quds Bank",
                },
                {
                  label: t.donate.bankDetails.iban,
                  value:
                    locale === "ar"
                      ? "PS45ALDN020200301670020061000"
                      : "PS45ALDN020200301670020061000",
                },
                {
                  label: t.donate.bankDetails.swift,
                  value: locale === "ar" ? "ALDNPS22" : "ALDNPS22",
                },
              ].map((item, index) => (
                <div
                  key={index}
